<%@ Page Language="C#" MasterPageFile="~/Main/Admin.Master" AutoEventWireup="true" CodeBehind="Ingreso_Diagnostico.aspx.cs" Inherits="HospOnline.Main.Ingreso_Diagnostico" %>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Diagnosticos Diarios</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                    ...
                    <div class="box-body" style="display: block;">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-xs-5">
                                        <div class="form-group">
                                            <label for="InputEstado">Fecha Diagnostico:</label>
                                    ...
                                    <div class="col-xs-10">
                                        <div class="form-group">
                                            <label for="InputNombre">Diagnostico:</label>
                                            <asp:TextBox ID="txtDescripcionDiagnostico" TextMode="MultiLine" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-xs-5">
                                        <div class="form-group">
