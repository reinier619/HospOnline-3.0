        ...
        public void descargarPDF()
        {
            using (var ms = new MemoryStream())
            {
                using (var doc = new Document(PageSize.A4, 50, 50, 15, 15))
                {
                    ...
                    Paragraph TituloMedicamentos = new Paragraph("Diagnóstico Diario");
                    ...
                    TituloDescripcionDiag.AddElement(new Paragraph("Diagnóstico"));
                    ...
                    TituloFechaInicio.AddElement(new Paragraph("Fecha Diagnóstico"));
                    ...
                    Int64 cantidadExamenes = gvDiagonosticoDiario.Rows.Count;

                    if (cantidadExamenes > 0)
                    {
                        foreach (GridViewRow row in gvDiagonosticoDiario.Rows)
                        {
