<%@ Page Language="C#" MasterPageFile="~/Main/Admin.Master" AutoEventWireup="true" CodeBehind="Consulta_Tratamiento.aspx.cs" Inherits="HospOnline.Main.Consulta_Tratamiento" %>
            ...
            <div class="col-md-10">
                <div class="box box-warning collapsed-box">
                    ...
                    <div class="box-body" style="display: none;">
                        <asp:GridView AutoGenerateColumns="false" runat="server" ID="gvTratamiento" CssClass="table table-bordered table-hover dataTable" EmptyDataText="No existen tratamientos." ShowHeader="true" Visible="true" >
                            <Columns>
                                <asp:BoundField DataField="descripcion" HeaderText="Tratamiento"  />
